...
exports.publish   = gulp.series(cleanAssets, publishHtml,  publishFonts, publishImages, publishJavascript);
exports.build     = gulp.series(cleanAssets, publishHtmlProduction,  publishFonts, publishImages, publishJavascript, compileScssProduction);
exports.build_dev = gulp.series(cleanAssets, publishHtmlDevelopment, publishFonts, publishImages, publishJavascript, compileScssDevelopment);
exports.watch     = gulp.series(cleanAssets, publishHtmlDevelopment, publishFonts, publishImages, publishJavascript, compileScssDevelopment, serve, watchFiles);
